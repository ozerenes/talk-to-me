...
let love = ['i dont know','You are my love','Love is not here...'];
let book = ['yes, Stefan Zweig books is always good','Did you hear Oguz Atay','yeah, crime and punishment, chess'];
...
function chatbotvoice(message){
    ...
    if(message.includes('What is love' || 'Love')){
        let finalresult = love[Math.floor(Math.random() * love.length)];
        speech.text = finalresult;
    }
    if(message.includes('Can you advice book for me' || 'advice book')){
